...
public class Database implements I_Database {
	...
	public Database() throws ParseException, Exception
	{
		...
		users.add(new Manager(1, "Monster", "Cookie", "Cookie.Monster@gmail.com", "087XXXXXXX0", "cookies"));
		users.add(new Picker(2, "the Frog", "Kermit", "Kermit.the.Frog@gmail.com", "087XXXXXXX1", "swamp"));
		users.add(new Packer(3, "Bird","Big", "Big.Bird@gmail.com", "087XXXXXXX2", "yellow"));
